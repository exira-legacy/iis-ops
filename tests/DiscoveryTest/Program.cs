namespace DiscoveryTest
{
    ...
    class Program
    {
        ...
        {
            var a = EventStore.connect(new Configuration(IPAddress.Parse("127.0.0.1"), 1113, "admin", "changeit"));

            var b = new EventStoreOptions
            {
                Configuration = new Configuration(IPAddress.Parse("127.0.0.1"), 1113, "admin", "changeit")
            };
